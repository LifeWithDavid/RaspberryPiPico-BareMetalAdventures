...
//Life with David - BMA Chapter 05 - Demo 3 - Setting Ring Oscillator
// and freqA and FreqB
.section .reset, "ax"
.global start
start:
// This sets up FREQa and FREQB	
	ldr r0, =rosc_base	// ring oscillator base
	ldr r1, =rosc_powr	// load in password and values for FREQA and FREQB
...
// This sets up the rosc clock divisor
	mov r1, #0xaa		// load 10101010 into r1
	lsl r1, r1, #4		// move to 101010100000 
	add r1, r1, #1		// and divisor equals 1 (full speed)
...
// This sets up the rosc speed 	
	...
	add r1, r1, #7 		// select "high" speed (4=low, 5=med, 6=toohigh) 2.17.8
...
.equ rosc_set,	0x40062000 	// Ring oscillator atomic set register
