...
copy_loop:
	...
	bl one_blink	// debug turn on LED GPIO25  blink for each half word tranfer
...
// just waste time
waste_time:
	bl led_on			// debug turn on LED GPIO25
	bl delay
	bl led_off
	bl delay
	b waste_time
...
one_blink:				// will blink GPIO25 one time
	push {lr}
	bl led_on		
	bl delay
	bl led_off
...
pio_prog:
//						mainloop: from PIO episode 7, example 1
