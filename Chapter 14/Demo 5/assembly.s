/* bare metal assembly
 Life with David - BMA Chapter 14_5 - DMA -
 Demonstrates DMA non increment operation by copying over every value from 
 block 1 and storing it in a single byte in Block 2.  
...
// ********copies all data of block 1 into 1 byte of block 2 (no increment of block 2)***
.cpu cortex-m0plus
.thumb
...
.equ dma_wrt_addr,	0x20020003		// single address of value to write to
.equ blk_2_start,	0x20020000	    // Start of data block 2
.equ num_transfers,0x40			// number of transfers
.equ dma_config, 	0x001f8011			// DMA Config
...
// use DMA to move data from block 1 to block 2
	...
	bl reg_prt
	bl prt_cr_lf			// print a new line
	str r4, [r5, #12]		// store the control register and trigger the DMA transfer sequence
