/* BMA17-Demo 4: This program sends the number of the control key function to an 
   assembly program using then multi-core FIFO register.  The assembly program returns the keycode 
   to the C program using the multi-core FIFO registerthat then prints out the result to the terminal.
   The assembly and C programs uses interrupts.*/
/**
...
void  core1_FIFO_ISR (void) { //This ISR reads one word from core 0 -> core 1 FIFO"
		printf("entering core1_FIFO_ISR \n");
