...
int main(void) {
    stdio_init_all();
	multicore_fifo_drain();      //to drain the core 1 to core 0 fifo 
	multicore_fifo_clear_irq();  // and remove any artifacts
	sleep_ms(20000);  //delay for 20 seconds to get USB/puTTY started
